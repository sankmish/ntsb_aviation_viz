// update and load chart on call, update chart title
// use region window to highlight month of interest
...
// build metadata and populate sample metadata panel
// use specific descriptions, append one block at a time
